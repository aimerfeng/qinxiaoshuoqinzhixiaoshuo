...
async function main() {
  console.log('[FORWARD] Starting from beginning...\n');
  ...
  for (let i = 0; i < novels.length; i++) {
    ...
    process.stdout.write(`[FWD ${i + 1}/${novels.length}] ${novel.main.substring(0, 35)}...`);
  ...
  console.log(`\n[FORWARD] Done: ${imported} imported, ${failed} failed`);
}
