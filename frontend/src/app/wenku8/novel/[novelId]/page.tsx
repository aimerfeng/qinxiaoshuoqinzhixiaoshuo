...
import { ArrowLeft, BookOpen, User, Clock, Tag, ChevronDown, ChevronUp } from 'lucide-react';
      ...
      {isOpen && (
        <div className="p-2 grid grid-cols-1 sm:grid-cols-2 gap-1">
          {volume.chapters.map((chapter) => (
            <Link
              key={chapter.id}
              href={`/wenku8/novel/${novelId}/chapter/${chapter.id}`}
...
export default function Wenku8NovelPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-4xl px-4 py-6">
        {/* Back Link */}
        <Link href="/wenku8" className="inline-flex items-center gap-2 text-muted-foreground hover:text-foreground mb-4">
